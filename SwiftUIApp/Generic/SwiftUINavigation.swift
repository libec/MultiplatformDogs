...
struct SwiftUINavigation: Coordinator, ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            .background(NavigationLink(destination: instanceProvider.resolve(BreedDetailView.self, argument: BreedDetailStrategy.specificBreed), isActive: $shownBreedDetail) { EmptyView() })
